...
if (-not (Test-Path $compiler)) {
    ...
    Write-Output "In CS2 settings search for 'Install Counter-Strike Workshop Tools', install them and restart Steam/CS2."
    exit 1
}
...
Write-Output ""
Write-Output "HUD compiled and copied to the local CS2 client."

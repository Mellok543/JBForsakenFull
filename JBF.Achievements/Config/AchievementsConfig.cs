...
internal sealed class AchievementsConfig
{
    ...
    [
        ...
        new() { Id="rebels-killed-25", Name="Контроль ситуации", Description="Убить 25 бунтующих заключённых за КТ.", Category="Охрана", StatKey="rebels_killed", Target=25, Reward=new(){ BonusArmor=2 } },
        new() { Id="rebels-killed-100", Name="Подавление", Description="Убить 100 бунтующих заключённых за КТ.", Category="Охрана", StatKey="rebels_killed", Target=100, Reward=new(){ BonusArmor=5 } },
        ...
        new() { Id="rebel-25", Name="Нарушитель", Description="Начать бунт в 25 разных раундах.", Category="Заключённый", StatKey="times_became_rebel", Target=25, Reward=new(){ BonusHealth=2 } },
        new() { Id="rebel-100", Name="Бунтарская кровь", Description="Начать бунт в 100 разных раундах.", Category="Заключённый", StatKey="times_became_rebel", Target=100, Reward=new(){ SpeedMultiplier=1.02f } },
        new() { Id="freeday-25", Name="Свободный режим", Description="Получить FreeDay в 25 раундах.", Category="Заключённый", StatKey="freedays_received", Target=25, Reward=new(){ BonusHealth=2 } },
        new() { Id="freeday-100", Name="Любимчик судьбы", Description="Получить FreeDay в 100 раундах.", Category="Заключённый", StatKey="freedays_received", Target=100, Reward=new(){ BonusHealth=3 } },
